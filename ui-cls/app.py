...
def camera_loop():
    ...
    This runs in a separate thread and continuously captures frames
    from the camera, classifies them, and displays the results.
    The user can press 'q' to quit or stop via the web interface.
    """
    ...
    if not cap.isOpened():
        print("❌ Could not access camera - make sure it's connected")
        return
